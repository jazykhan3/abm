        ...
        <div className="flex">
          ...
          <div className="w-full md:w-1/2 p-8">
            ...
            <div className="flex justify-end mb-4">
              <button
                onClick={onClose}
                className="w-8 h-8 bg-[#DE5FCB] hover:bg-[#DE5FCB]/80 rounded-full flex items-center justify-center text-white text-xl font-bold transition-colors duration-200"
